...
public class StringUtil {
    ...
    /**
	 * 群发短信，适用于给多个号码发送相同短信
	 * @param mobiles 手机号码，号码之间用;分开
	 * @param content 短信内容
	 * @return
	 */
	public static String[] getMobiles(String mobiles) {
		//容错处理
		mobiles = mobiles.replaceAll(" ", "");	//去掉所有空格
		mobiles = mobiles.replaceAll("\n", "");	//去掉所有回车符
		mobiles = mobiles.replaceAll("\r", "");	//去掉所有换行符
		mobiles = mobiles.replaceAll("，", ";");	//把全角逗号替换成半角分号
		mobiles = mobiles.replaceAll(",", ";");	//把逗号替换成半角分号
		mobiles = mobiles.replaceAll("；", ";");	//把全角分号替换成半角分号
