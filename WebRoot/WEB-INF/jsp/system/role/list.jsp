...
function addFun(){
	 $("#addPage").modal({
		    remote: "roleController.do?addPage"
	});
}
function detele(id){
	bootbox.confirm("是否删除此角色信息，请慎重！", function(result) {
		if(result) {
			var url = "roleController.do?detele";
...
function edit(id){
	 $("#addPage").modal({
		    remote: "roleController.do?addPage&id="+id
	});
}

function grant(id){
	 $("#grantPage").modal({
		    remote: "roleController.do?grantPage&id="+id
	});
}
