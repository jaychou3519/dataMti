              ...
              <div class="modal-body">
				   ...
				   <input type="hidden" id="id" name="id" value="${resource.id }" />
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="name" name="name" value="${resource.name }"  class="span2" maxlength="20" placeholder="请输入名称" regxType="tel" rel="popover" required  />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="url" name="url" value="${resource.url }"  class="span2" maxlength="200" placeholder="请输入地址" regxType="tel" rel="popover" required  />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="seq" name="seq" value="${resource.seq }" class="span2"  placeholder="请输入排序号" regxType="tel" rel="popover" required  />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="remark" name="remark" value="${resource.remark }"  class="span2"  placeholder="请输入备注" regxType="tel" rel="popover" required  />
						</div>
					</div>
...
function save(){
	...
	var url = "resourceController.do?save";
