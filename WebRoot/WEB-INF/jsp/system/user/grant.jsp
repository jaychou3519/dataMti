...
<div class="modal-dialog" style="width:980px;">
      <div class="modal-content">
              ...
              <div class="modal-body">
				   <form class="form-horizontal" role="form" id="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
								<input id="roleIds" name="roleIds" type="hidden" readonly value="" class="span2"  />
								<input id="roleNames" name="roleNames" type="text" readonly value="" class="span2"  />
            ...
            <div class="modal-footer">
             	 <button type="button" class="btn btn-primary btn-sm" onClick="return grantRole();" anchor="top">确认</button>
...
function grantRole(){
	var url = "userController.do?grant";
